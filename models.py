...
class Company(Base):
    ...
    opening_balances_date = Column(
        Date,
        nullable=True,
        comment="The date when opening balances were entered; null if not set"
    )
    opening_balances_locked = Column(
        Boolean,
        default=False,
        nullable=False,
        comment="True once opening balances are finalized and cannot be edited"
    )
    ...
    opening_balances = relationship('OpeningBalance', back_populates='company')
    vendor_balances = relationship('OpeningBalanceVendor', back_populates='company')
    ...
    payment_modes = relationship('PaymentMode', back_populates='company')

    journals = relationship('Journal', back_populates='company')

    # Payroll
    employees = relationship('Employee', back_populates='company')
    payroll_transactions = relationship('PayrollTransaction', back_populates='company')
    departments = relationship('Department', back_populates='company')
    benefit_types = relationship("BenefitType", back_populates="company")
    deduction_types = relationship("DeductionType", back_populates="company")
    payroll_periods = relationship("PayrollPeriod", back_populates="company")
    benefits = relationship("Benefit", back_populates="company")
    deductions = relationship("Deduction", back_populates="company")
    advance_payments = relationship("AdvancePayment", back_populates="company")
    advance_repayments = relationship("AdvanceRepayment", back_populates="company")
    ...
    inventory_item_variation = relationship('InventoryItemVariation', back_populates='company')
    inventory_item_variation_link = relationship('InventoryItemVariationLink', back_populates='company')
    inventory_item = relationship('InventoryItem', back_populates='company')
    inventory_entry_line_items = relationship('InventoryEntryLineItem', back_populates='company')
    inventory_category = relationship('InventoryCategory', back_populates='company')
    inventory_subcategory = relationship('InventorySubCategory', back_populates='company')
    inventory_item_attributes = relationship('InventoryItemAttribute', back_populates='company')
    inventory_location = relationship('InventoryLocation', back_populates='company')
    brands = relationship('Brand', back_populates='company')
    exchange_rates = relationship('ExchangeRate', back_populates='company')
    unit_of_measurement = relationship('UnitOfMeasurement', back_populates='company')
    inventory_transaction_details = relationship('InventoryTransactionDetail', back_populates='company')
    item_selling_prices = relationship("ItemSellingPrice", back_populates="company")
    user_location_assignments = relationship("UserLocationAssignment", back_populates="company")
    customer_groups = relationship("CustomerGroup", back_populates="company")

    sales_orders = relationship('SalesOrder', back_populates='company')
    sales_order_items = relationship('SalesOrderItem', back_populates='company')
    sales_order_status_logs = relationship('SalesOrderStatusLog', back_populates='company')
    sales_order_history = relationship('SalesOrderHistory', back_populates='company')
    invoices = relationship('SalesInvoice', back_populates='company')
    sales_invoice_items = relationship('SalesInvoiceItem', back_populates='company')
    sales_invoice_notes = relationship('SalesInvoiceNote', back_populates='company')
    sales_order_notes = relationship('SalesOrderNote', back_populates='company')
    sales_order_attachments = relationship('SalesOrderAttachment', back_populates='company')
    sales_order_approvals = relationship('SalesOrderApproval', back_populates='company')
    sales_invoice_approvals = relationship('SalesInvoiceApproval', back_populates='company')
    sales_invoice_history = relationship('SalesInvoiceHistory', back_populates='company')
    sales_invoice_status_logs = relationship('SalesInvoiceStatusLog', back_populates='company')
    direct_sale_items = relationship("DirectSaleItem", back_populates='company')
    direct_sales = relationship("DirectSalesTransaction", back_populates='company')

    bulk_payments = relationship("BulkPayment", back_populates="company")

    payment_receipts = relationship('PaymentReceipt', back_populates='company')

    delivery_reference_number = relationship('DeliveryReferenceNumber', back_populates='company')
    delivery_note_items = relationship('DeliveryNoteItem', back_populates='company')
    delivery_notes = relationship('DeliveryNote', back_populates='company')
    delivery_note_notes = relationship('DeliveryNoteNote', back_populates='company')
    sales_returns = relationship('SalesReturn', back_populates='company')
    sales_transaction = relationship('SalesTransaction', back_populates='company')
    payment_allocations = relationship('PaymentAllocation', back_populates='company')

    backorders = relationship('Backorder', back_populates='company')
    backorder_items = relationship('BackorderItem', back_populates='company')
    backorder_fulfillments = relationship('BackorderFulfillment', back_populates='company')

    # Add quotation relationships to the Company model
    quotations = relationship('Quotation', back_populates='company')
    quotation_items = relationship('QuotationItem', back_populates='company')
    quotation_approvals = relationship('QuotationApproval', back_populates='company')
    quotation_history = relationship('QuotationHistory', back_populates='company')
    quotation_status_logs = relationship('QuotationStatusLog', back_populates='company')
    quotation_notes = relationship('QuotationNote', back_populates='company')
    quotation_attachments = relationship('QuotationAttachment', back_populates='company')
    ...
    purchase_order_history = relationship('PurchaseOrderHistory', back_populates='company')
    purchase_order_status_logs = relationship('PurchaseOrderStatusLog', back_populates='company')
    purchase_order_notes = relationship('PurchaseOrderNote', back_populates='company')
    purchase_order_approvals = relationship('PurchaseOrderApproval', back_populates='company')
    purchase_returns = relationship('PurchaseReturn', back_populates='company')
    direct_purchases = relationship("DirectPurchaseTransaction", back_populates='company')
    direct_purchase_items = relationship("DirectPurchaseItem", back_populates='company')
    purchase_payment_allocations = relationship('PurchasePaymentAllocation', back_populates='company')
    purchase_transactions = relationship("PurchaseTransaction", back_populates='company')
    goods_receipts = relationship("GoodsReceipt", back_populates='company')
    goods_receipt_items = relationship("GoodsReceiptItem", back_populates='company')

    loan_application = relationship('LoanApplication', back_populates='company')
    loan_applicant = relationship('LoanApplicant', back_populates='company')
    loan_history = relationship('LoanHistory', back_populates='company')

    currency_exchange_transaction = relationship('CurrencyExchangeTransaction', back_populates='company')

    # Expense Transactions
    expense_transactions = relationship('ExpenseTransaction', back_populates='company')

    customer_credits = relationship("CustomerCredit", back_populates="company")
    credit_applications = relationship("CreditApplication", back_populates="company")

    # Asset
    asset_items = relationship("AssetItem", back_populates="company")
    assets = relationship("Asset", back_populates="company")
    asset_movements = relationship("AssetMovement", back_populates="company")
    maintenance_records = relationship("MaintenanceRecord", back_populates="company")
    depreciation_records = relationship("DepreciationRecord", back_populates="company")
    asset_transfers = relationship("AssetTransfer", back_populates="company")
    asset_movement_line_items = relationship("AssetMovementLineItem", back_populates="company",
                                             cascade="all, delete-orphan")

    # Optional: constructor for easy instance creation
    def __init__(self, app_name, name, address, package, phone, email, website, api_key=None, logo=None, footer=None,
                 footer_type=None, date_created=None):
        ...
        self.date_created = date_created or datetime.today()
        # Generate API key in the same format as MySQL
        if api_key is None:
            today = datetime.today().strftime("%d%m%y")  # Format as ddmmyy
            self.api_key = f"{today}-api-{uuid.uuid4()}"
        else:
            self.api_key = api_key  # Use the provided key if available

    # ✅ Add property for base_currency
    @property
    def base_currency(self):
        """
        Returns the company's base currency (currency_index == 1).
        ...
        return (
            ...
            .filter_by(app_id=self.id, currency_index=1)
            .first()
        )
...
class User(Base):
    ...
    # Add timezone field - default to UTC but can be set per user
    timezone = Column(String(50), default='UTC', nullable=False)

    # Adding the reset_token column
    reset_token = Column(String(255), nullable=True)

    quotation_approvals = relationship('QuotationApproval', back_populates='approver')
    quotation_history = relationship('QuotationHistory', back_populates='user')
    quotation_status_logs = relationship('QuotationStatusLog', back_populates='user')
    sales_order_status_logs = relationship('SalesOrderStatusLog', back_populates='user')
    sales_order_history = relationship("SalesOrderHistory", back_populates="user")
    sales_order_notes = relationship('SalesOrderNote', back_populates='user', foreign_keys='SalesOrderNote.created_by')
    sales_order_notes_recipient = relationship('SalesOrderNote', back_populates='user_recipient',
                                               foreign_keys='SalesOrderNote.recipient')
    sales_order_approvals = relationship('SalesOrderApproval', back_populates='approver')
    sales_invoice_approvals = relationship('SalesInvoiceApproval', back_populates='approver')
    sales_invoice_notes = relationship('SalesInvoiceNote', back_populates='user',
                                       foreign_keys='SalesInvoiceNote.created_by')
    sales_invoice_notes_recipient = relationship('SalesInvoiceNote', back_populates='user_recipient',
                                                 foreign_keys='SalesInvoiceNote.recipient')

    sales_invoice_history = relationship('SalesInvoiceHistory', back_populates='user')
    sales_invoice_status_logs = relationship('SalesInvoiceStatusLog', back_populates='user')
    invoices = relationship('SalesInvoice', back_populates='user')
    payment_receipts = relationship('PaymentReceipt', back_populates='user')
    direct_sales = relationship('DirectSalesTransaction', back_populates='user')
    sales_transaction = relationship('SalesTransaction', back_populates='user')

    bulk_payments = relationship("BulkPayment", back_populates="creator", foreign_keys="BulkPayment.created_by")

    user_preferences = relationship('UserPreference', back_populates='user')
    notifications = relationship('Notification', back_populates='user')
    quotation_notes = relationship('QuotationNote', back_populates='user', foreign_keys='QuotationNote.created_by')
    quotation_notes_recipient = relationship('QuotationNote', back_populates='user_recipient',
                                             foreign_keys='QuotationNote.recipient')
    delivery_notes = relationship('DeliveryNote', back_populates='user')
    delivery_note_notes = relationship('DeliveryNoteNote', back_populates='user',
                                       foreign_keys='DeliveryNoteNote.created_by')
    delivery_note_notes_recipient = relationship('DeliveryNoteNote', back_populates='user_recipient',
                                                 foreign_keys='DeliveryNoteNote.recipient')

    backorders = relationship('Backorder', back_populates='user')

    created_journals = relationship('Journal', back_populates='created_user',
                                    foreign_keys='Journal.created_by')

    updated_journals = relationship('Journal', back_populates='updated_user',
                                    foreign_keys='Journal.updated_by')

    created_inventory_transactions = relationship('InventoryEntry', back_populates='created_user',
                                                  foreign_keys='InventoryEntry.created_by')
    updated_inventory_transactions = relationship('InventoryEntry', back_populates='updated_user',
                                                  foreign_keys='InventoryEntry.updated_by')

    user_location_assignments = relationship("UserLocationAssignment", back_populates="user",
                                             foreign_keys='UserLocationAssignment.user_id')

    assigned_user_locations = relationship(
        "UserLocationAssignment",
        foreign_keys="[UserLocationAssignment.assigned_by]",
    ...
    purchase_order_status_logs = relationship('PurchaseOrderStatusLog', back_populates='user')
    purchase_order_history = relationship('PurchaseOrderHistory', back_populates='user')
    purchase_transactions = relationship('PurchaseTransaction', back_populates='user')
    direct_purchases = relationship('DirectPurchaseTransaction', back_populates='user')
    purchase_returns = relationship('PurchaseReturn', back_populates='user')
    module_access = relationship('UserModuleAccess', back_populates='user')
    chart_of_account = relationship('ChartOfAccounts', back_populates='user')

    expense_transactions = relationship('ExpenseTransaction', back_populates='user')
    created_selling_prices = relationship("ItemSellingPrice", foreign_keys="[ItemSellingPrice.created_by]",
                                          back_populates="created_user")
    updated_selling_prices = relationship("ItemSellingPrice", foreign_keys="[ItemSellingPrice.updated_by]",
                                          back_populates="updated_user")

    created_customer_groups = relationship("CustomerGroup", foreign_keys="[CustomerGroup.created_by]",
                                           back_populates="created_user")
    updated_customer_groups = relationship("CustomerGroup", foreign_keys="[CustomerGroup.updated_by]",
                                           back_populates="updated_user")

    customer_credits = relationship("CustomerCredit", back_populates="creator",
                                    foreign_keys="CustomerCredit.created_by")
    credit_applications = relationship("CreditApplication", back_populates="applier",
                                       foreign_keys="CreditApplication.applied_by")
    vendor_balances = relationship('OpeningBalanceVendor', back_populates='creator')
    created_exchange_rates = relationship('ExchangeRate', back_populates='creator')

    # Created asset movements relationship
    created_asset_movements = relationship(
        "AssetMovement",
        foreign_keys="[AssetMovement.created_by]",
        back_populates="creator"
    )

    # Payroll
    payroll_periods = relationship('PayrollPeriod', back_populates="creator")
    payroll_transactions = relationship('PayrollTransaction', back_populates="creator")
    payroll_payments = relationship('PayrollPayment', back_populates="creator")
    deduction_payments = relationship('DeductionPayment', back_populates="creator")
    ...
    def check_password(self, password):
        ...
        if isinstance(self.password, str):
            stored_password = self.password.encode('utf-8')  # Convert to bytes if it's a string
        else:
            stored_password = self.password  # Use as is if it's already bytes
...
class Notification(Base):
    ...
    company_id = Column(Integer, ForeignKey('companies.id'), nullable=True)  # Nullable for user-specific notifications
...
class Currency(Base):
    ...
    app_id = Column(Integer, ForeignKey('companies.id'), nullable=False)
    company = relationship("Company", back_populates="currency")
...
class ExchangeRate(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_exchange_rates_app_currency', 'app_id', 'from_currency_id', 'to_currency_id'),
...
class CurrencyExchangeTransaction(Base):
    ...
    company = relationship("Company", back_populates="currency_exchange_transaction")
...
class OpeningBalance(Base):
    ...
    company = relationship('Company', back_populates='opening_balances')
    creator = relationship('User')

    # Index for performance on queries filtering by account and company
    __table_args__ = (
        Index('ix_opening_balances_account_app', 'account_id', 'app_id'),
    )
...
class OpeningBalanceVendor(Base):
    ...
    company = relationship('Company', back_populates='vendor_balances')
    ...
    __table_args__ = (
        ...
        Index('ix_opening_balance_vendors_app', 'app_id'),
    )
...
class Category(Base):
    ...
    __table_args__ = (
        Index('idx_categories_app_id', 'app_id'),  # If you filter by app_id
    )
...
class Project(Base):
    ...
    __table_args__ = (
        UniqueConstraint('project_id', 'app_id', name='uq_project_id_app_id'),
    )

    # Indexes for better query performance
    Index('ix_projects_app_id', 'app_id'),
    Index('ix_projects_is_active', 'is_active'),
    Index('ix_projects_app_active', 'app_id', 'is_active')
...
class CustomerCredit(Base):
    ...
    company = relationship("Company", back_populates="customer_credits")
...
class CreditApplication(Base):
    ...
    company = relationship("Company", back_populates="credit_applications")
...
class PaymentMode(Base):
    ...
    company = relationship('Company', back_populates='payment_modes')
...
class Journal(Base):
    ...
    app_id = Column(Integer, ForeignKey('companies.id'), nullable=False, index=True)
    ...
    __table_args__ = (
        Index('idx_journals_app_id_date', 'app_id', 'date'),
        Index('idx_journals_app_id_status', 'app_id', 'status'),
        Index('idx_journals_app_id_vendor', 'app_id', 'vendor_id'),
        Index('idx_journals_app_id_project', 'app_id', 'project_id'),
        Index('idx_journals_app_id_created', 'app_id', 'created_by', 'date_added'),
        # ADD THESE NEW INDEXES:
        Index('idx_journals_app_status_date', 'app_id', 'status', 'date'),  # Most important!
        ...
        # ADD THESE:
        Index('idx_journals_app_status_date_currency', 'app_id', 'status', 'date', 'currency_id'),
        Index('idx_journals_app_status_date_exchange', 'app_id', 'status', 'date', 'exchange_rate_id'),
...
class JournalEntry(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_journal_entries_app_id_date', 'app_id', 'date'),
        Index('idx_journal_entries_app_id_subcategory', 'app_id', 'subcategory_id'),
        Index('idx_journal_entries_app_id_dr_cr', 'app_id', 'dr_cr'),
        Index('idx_journal_entries_journal_number', 'journal_number'),

        # ADD THESE NEW INDEXES:
        Index('idx_entries_app_journal', 'app_id', 'journal_id'),  # For joining
        Index('idx_entries_subcategory_app', 'subcategory_id', 'app_id'),  # For category filtering

        Index('idx_entries_app_subcategory_journal', 'app_id', 'subcategory_id', 'journal_id'),
        Index('idx_entries_app_date_dr_cr', 'app_id', 'date', 'dr_cr'),
...
def set_denormalized_fields(mapper, connection, target):
    if target.journal_id is not None:
        journal = connection.execute(
            select(Journal.journal_number, Journal.app_id, Journal.date)
            .where(Journal.id == target.journal_id)
        ).first()

        if journal:
            target.journal_number = journal.journal_number
            target.app_id = journal.app_id
...
class LoanApplicant(Base):
    ...
    company = relationship('Company', back_populates='loan_applicant')
...
class LoanApplication(Base):
    ...
    company = relationship('Company', back_populates='loan_application')
...
class LoanHistory(Base):
    ...
    company = relationship('Company', back_populates='loan_history')
...
class Employee(Base):
    ...
    # Indexes for better query performance
    Index('ix_employees_app_id', 'app_id'),
    ...
    Index('ix_employees_app_active', 'app_id', 'is_active'),
    Index('ix_employees_app_department', 'app_id', 'department_id'),
    Index('ix_employees_app_project', 'app_id', 'project_id'),  # Added composite index
    Index('ix_employees_name_search', 'first_name', 'last_name'),
    Index('ix_employees_app_status_active', 'app_id', 'employment_status', 'is_active')
...
class PayrollTransaction(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_payroll_transactions_exchange_rate', 'exchange_rate_id'),  # ADD THIS
        Index('idx_payroll_transactions_app', 'app_id'),
...
class PayrollPeriod(Base):
    ...
    app_id = Column(Integer, ForeignKey('companies.id'), nullable=True)
    ...
    __table_args__ = (
        UniqueConstraint('payroll_period_name', 'app_id', name='_payroll_period_name_app_uc'),
    )
...
class Deduction(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_deductions_exchange_rate', 'exchange_rate_id'),  # ADD THIS
...
class BenefitType(Base):
    ...
    company = relationship("Company", back_populates="benefit_types")
...
class AdvancePayment(Base):
    ...
    company = relationship('Company', back_populates='advance_payments')
...
class AdvanceRepayment(Base):
    ...
    company = relationship('Company', back_populates='advance_repayments')
...
class AssetItem(Base):
    ...
    # Accounting defaults
    fixed_asset_account_id = Column(Integer, ForeignKey('chart_of_accounts.id'), nullable=True)
    depreciation_expense_account_id = Column(Integer, ForeignKey('chart_of_accounts.id'), nullable=True)
    ...
    company = relationship("Company", back_populates="asset_items")
...
class Asset(Base):
    ...
    company = relationship("Company", back_populates="assets")  # ADD back_populates
...
class AssetMovement(Base):
    ...
    company = relationship('Company', back_populates='asset_movements')
...
class AssetMovementLineItem(Base):
    ...
    company = relationship('Company', back_populates="asset_movement_line_items")
...
class DepreciationRecord(Base):
    ...
    company = relationship("Company", back_populates="depreciation_records")
...
class AssetTransfer(Base):
    ...
    # ✅ UPDATE relationships:
    company = relationship("Company", back_populates="asset_transfers")
...
class InventoryItem(Base):
    ...
    cogs_account_id = Column(Integer, ForeignKey('chart_of_accounts.id'), nullable=True)
    ...
    company = relationship("Company", back_populates="inventory_item")
...
class ItemSellingPrice(Base):
    ...
    # Relationships
    company = relationship("Company", back_populates="item_selling_prices")
...
class CustomerGroup(Base):
    ...
    # Relationships
    company = relationship("Company", back_populates="customer_groups")
    ...
    # Indexes for better performance
    __table_args__ = (
        Index('ix_customer_groups_app_id', 'app_id'),
        ...
        UniqueConstraint('app_id', 'name', name='uq_customer_group_name_per_company'),
    )
...
class UnitOfMeasurement(Base):
    ...
    id = Column(Integer, primary_key=True)
    app_id = Column(Integer, ForeignKey('companies.id'), nullable=False)  # Assuming this relates to a company
    ...
    # Relationships
    company = relationship("Company", back_populates="unit_of_measurement")  # Assuming a company can have multiple UoMs
    ...
    def __init__(self, app_id, full_name, abbreviation=None):
        self.app_id = app_id
...
class InventoryCategory(Base):
    ...
    company = relationship("Company", back_populates="inventory_category")
...
class InventorySubCategory(Base):
    ...
    company = relationship("Company", back_populates="inventory_subcategory")
...
class InventoryItemAttribute(Base):
    ...
    company = relationship("Company", back_populates="inventory_item_attributes")
...
class InventoryItemVariation(Base):
    ...
    company = relationship("Company", back_populates="inventory_item_variation")
    inventory_item_variation_link = relationship("InventoryItemVariationLink",
...
class InventoryItemVariationLink(Base):
    ...
    company = relationship("Company", back_populates="inventory_item_variation_link")
...
class InventoryLocation(Base):
    ...
    company = relationship("Company", back_populates="inventory_location")
...
class InventoryTransactionDetail(Base):
    ...
    company = relationship("Company", back_populates="inventory_transaction_details")
    ...
    __table_args__ = (
        ...
        Index('ix_transaction_details_app_date', 'app_id', 'transaction_date'),
    )
...
class InventorySummary(Base):
    ...
    # Relationships
    company = relationship('Company', back_populates='inventory_summary')
    ...
    __table_args__ = (
        UniqueConstraint('app_id', 'item_id', 'location_id', name='uq_inventory_summary'),
        Index('ix_summary_app_item', 'app_id', 'item_id'),
        Index('ix_summary_app_location', 'app_id', 'location_id'),
        Index('ix_summary_app_item_location', 'app_id', 'item_id', 'location_id'),
    )
...
class PurchaseOrder(Base):
    ...
    __table_args__ = (
        UniqueConstraint('purchase_order_number', 'app_id', name='uq_po_number_app_id'),
        ...
        Index('idx_purchase_orders_app_date', 'app_id', 'purchase_order_date'),
...
class PurchaseOrderStatusLog(Base):
    ...
    company = relationship('Company', back_populates='purchase_order_status_logs')
...
class PurchaseOrderHistory(Base):
    ...
    company = relationship('Company', back_populates='purchase_order_history')
...
class PurchaseOrderNote(Base):
    ...
    company = relationship('Company', back_populates='purchase_order_notes')
...
class PurchaseOrderApproval(Base):
    ...
    company = relationship('Company', back_populates='purchase_order_approvals')
...
class PurchaseReturn(Base):
    ...
    company = relationship('Company', back_populates='purchase_returns')
    ...
    __table_args__ = (
        UniqueConstraint('return_number', 'app_id', name='uq_purchase_return_number_app_id'),
    )
...
class PurchaseTransaction(Base):
    ...
    company = relationship('Company', back_populates='purchase_transactions')
    ...
    __table_args__ = (
     # 1. Most critical - company + date range (used in dashboard and reports)
        ...
        Index('idx_purchase_transactions_app_status', 'app_id', 'payment_status'),
...
class DirectPurchaseTransaction(Base):
    ...
    company = relationship('Company', back_populates='direct_purchases')
    ...
    __table_args__ = (UniqueConstraint('direct_purchase_number', 'app_id', name='uq_direct_purchase_number_app_id'),)
...
class DirectPurchaseItem(Base):
    ...
    company = relationship('Company', back_populates='direct_purchase_items')
...
class PurchasePaymentAllocation(Base):
    ...
    company = relationship('Company', back_populates='purchase_payment_allocations')
...
class GoodsReceipt(Base):
    ...
    company = relationship('Company', back_populates='goods_receipts')
...
class GoodsReceiptItem(Base):
    ...
    company = relationship('Company', back_populates='goods_receipt_items')
...
class QuotationNote(Base):
    ...
    # Add quotation relationships to the Company model
    company = relationship('Company', back_populates='quotation_notes')
...
class QuotationAttachment(Base):
    ...
    company = relationship('Company', back_populates='quotation_attachments')
...
class Quotation(Base):
    ...
    __table_args__ = (
        UniqueConstraint('quotation_number', 'app_id', name='uq_quotation_number_app_id'),
...
class QuotationItem(Base):
    ...
    company = relationship('Company', back_populates='quotation_items')
...
class QuotationApproval(Base):
    ...
    company = relationship('Company', back_populates='quotation_approvals')
...
class QuotationHistory(Base):
    ...
    company = relationship('Company', back_populates='quotation_history')
...
class QuotationStatusLog(Base):
    ...
    company = relationship('Company', back_populates='quotation_status_logs')
...
class SalesOrderItem(Base):
    ...
    company = relationship('Company', back_populates='sales_order_items')
...
class SalesOrderStatusLog(Base):
    ...
    company = relationship('Company', back_populates='sales_order_status_logs')
...
class SalesOrderHistory(Base):
    ...
    company = relationship('Company', back_populates='sales_order_history')
...
class SalesOrderNote(Base):
    ...
    # Add quotation relationships to the Company model
    company = relationship('Company', back_populates='sales_order_notes')
...
class SalesOrderAttachment(Base):
    ...
    company = relationship('Company', back_populates='sales_order_attachments')
...
class SalesOrderApproval(Base):
    ...
    company = relationship('Company', back_populates='sales_order_approvals')
...
class SalesInvoice(Base):
    ...
    app_id = Column(Integer, ForeignKey('companies.id'), nullable=False)  # Linked to Company
    ...
    company = relationship('Company', back_populates='invoices')  # Linked to Company
    ...
    # Composite unique constraint
    __table_args__ = (
        UniqueConstraint('invoice_number', 'app_id', name='uq_invoice_number_app_id'),
        ...
        Index('idx_invoices_combined', 'app_id', 'customer_id', 'status'),  # Common combined filter
        ...
        Index('idx_invoices_app_date', 'app_id', 'invoice_date'),  # Company date range
    )
...
class SalesInvoiceItem(Base):
    ...
    company = relationship('Company', back_populates='sales_invoice_items')
...
class SalesInvoiceNote(Base):
    ...
    company = relationship('Company', back_populates='sales_invoice_notes')
...
class SalesInvoiceApproval(Base):
    ...
    company = relationship('Company', back_populates='sales_invoice_approvals')  # Linked to Company
...
class SalesInvoiceHistory(Base):
    ...
    company = relationship('Company', back_populates='sales_invoice_history')  # Linked to Company
...
class SalesInvoiceStatusLog(Base):
    ...
    company = relationship('Company', back_populates='sales_invoice_status_logs')  # Linked to Company
...
class BulkPayment(Base):
    ...
    company = relationship("Company", back_populates="bulk_payments")
    ...
    __table_args__ = (
        ...
        Index('idx_bulk_payments_app', 'app_id'),
...
class SalesTransaction(Base):
    ...
    company = relationship('Company', back_populates='sales_transaction')
...
class DirectSalesTransaction(Base):
    ...
    company = relationship('Company', back_populates='direct_sales')
    ...
    # Composite unique constraint
    __table_args__ = (UniqueConstraint('direct_sale_number', 'app_id', name='uq_direct_sale_number_app_id'),)
...
class DirectSaleItem(Base):
    ...
    company = relationship('Company', back_populates='direct_sale_items')
...
class PaymentAllocation(Base):
    ...
    company = relationship('Company', back_populates='payment_allocations')
...
class PaymentReceipt(Base):
    ...
    updated_at = Column(DateTime, default=lambda: datetime.now(timezone.utc),
                        onupdate=lambda: datetime.now(timezone.utc))
    app_id = Column(Integer, ForeignKey('companies.id'), nullable=False)  # Organization issuing the receipt
    ...
    company = relationship('Company', back_populates='payment_receipts')
    ...
    # Composite unique constraint
    __table_args__ = (UniqueConstraint('payment_receipt_number', 'app_id', name='uq_payment_receipt_number_app_id'),)
...
class DeliveryNote(Base):
    ...
    company = relationship('Company', back_populates='delivery_notes')
    ...
    # Composite unique constraint
    __table_args__ = (UniqueConstraint('delivery_number', 'app_id', name='uq_delivery_number_app_id'),)
...
class DeliveryNoteItem(Base):
    ...
    company = relationship('Company', back_populates='delivery_note_items')
...
class DeliveryReferenceNumber(Base):
    ...
    company = relationship('Company', back_populates='delivery_reference_number')
    delivery_notes = relationship('DeliveryNote', back_populates='delivery_reference')

    # Composite unique constraint
    __table_args__ = (
        UniqueConstraint('delivery_reference_number', 'app_id', name='uq_delivery_reference_number_app_id'),)
...
class DeliveryNoteNote(Base):
    ...
    company = relationship('Company', back_populates='delivery_note_notes')
...
class SalesReturn(Base):
    ...
    customer = relationship('Vendor', back_populates='sales_returns')
    company = relationship('Company', back_populates='sales_returns')

    # Composite unique constraint
    __table_args__ = (UniqueConstraint('return_number', 'app_id', name='uq_return_number_app_id'),)
...
class Backorder(Base):
    ...
    company = relationship('Company', back_populates='backorders')
    ...
    # Composite unique constraint
    __table_args__ = (UniqueConstraint('backorder_number', 'app_id', name='uq_backorder_number_app_id'),)
...
class BackorderItem(Base):
    ...
    company = relationship('Company', back_populates='backorder_items')
...
class BackorderFulfillment(Base):
    ...
    company = relationship('Company', back_populates='backorder_fulfillments')
...
class ExpenseTransaction(Base):
    ...
    company = relationship('Company', back_populates='expense_transactions')
    ...
    __table_args__ = (
        UniqueConstraint('expense_entry_number', 'app_id', name='uq_expense_entry_per_app'),
        Index('idx_expense_app_id', 'app_id'),
        Index('idx_expense_app_date', 'app_id', 'payment_date'),
        Index('idx_expense_vendor', 'vendor_id'),
        Index('idx_expense_currency', 'currency_id'),
        Index('idx_expense_app_status', 'app_id', 'status'),
    )
